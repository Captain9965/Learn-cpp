/*We cannot use operator overloading for fundamental data types*/
#include <cstdio>
#include <iostream>
using namespace std;
class Complex {
...
/*using & makes our code efficient by referencing the complex2 object
 ...
 using const is considered a good practice because
  it prevents the operator function from modifying complex2
